...
public class Settings extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String STATUS_PLUGIN_ESTIMOTE = "status_plugin_estimote";
    ...
    protected void onResume() {
        ...
        status = (CheckBoxPreference) findPreference(STATUS_PLUGIN_ESTIMOTE);
        if( Aware.getSetting(this, STATUS_PLUGIN_ESTIMOTE).length() == 0 ) {
            Aware.setSetting( this, STATUS_PLUGIN_ESTIMOTE, true ); //by default, the setting is true on install
        }
        status.setChecked(Aware.getSetting(getApplicationContext(), STATUS_PLUGIN_ESTIMOTE).equals("true"));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if( setting.getKey().equals(STATUS_PLUGIN_ESTIMOTE) ) {
        ...
        if (Aware.getSetting(this, STATUS_PLUGIN_ESTIMOTE).equals("true")) {
